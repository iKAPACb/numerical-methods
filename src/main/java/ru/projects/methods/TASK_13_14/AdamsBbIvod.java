...
public class AdamsBbIvod {
    ...
    public AdamsBbIvod(int i, double h, double x, double y, double yd, double ydd, double z, double delta_z, double delta_y, double istY, double accuracy) {
        this.i = i;
        this.h = h;
